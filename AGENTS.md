...
当前共同开发基准为 1.8.20（正式版，发布标签 v1.8.20，PR #11 合并提交 57ce6d3；实现提交 ef4db17，分支 trae/v1.8.20-icon-exit-hint，真机未验）。参与工具为 WorkBuddy、Trae Code 和 Codex。后续任务从包含该提交的最新 origin/main 开始，不得把旧工作目录整体覆盖到主分支；新的功能或修复从此基准递增版本（≥1.8.21/10821）。
