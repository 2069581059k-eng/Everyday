...
当前共同开发基准为 1.8.15（正式版，发布标签 v1.8.15，PR #6 合并提交 b6f5ead；实现提交 54aa335，分支 trae/v1.8.15-enhancements，真机验证通过）。参与工具为 WorkBuddy、Trae Code 和 Codex。后续任务从包含该提交的最新 origin/main 开始，不得把旧工作目录整体覆盖到主分支；新的功能或修复从此基准递增版本（≥1.8.16/10816）。
