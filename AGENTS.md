...
当前共同开发基准为 1.8.22（正式版，发布标签 v1.8.22，PR #13 合并提交 3fd5150；实现提交 3826131，分支 trae/v1.8.22-icon-restore，真机未验）。参与工具为 WorkBuddy、Trae Code 和 Codex。后续任务从包含该提交的最新 origin/main 开始，不得把旧工作目录整体覆盖到主分支；新的功能或修复从此基准递增版本（≥1.8.23/10823）。
