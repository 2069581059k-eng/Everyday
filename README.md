...
当前共同开发基准为 **1.8.22**（正式版，PR #13 合并 `3fd5150`，tag `v1.8.22` → 实现提交 `3826131`，真机未验），WorkBuddy、Trae Code 与 Codex 后续请从最新 `main` 继续开发。[下载 1.8.22 正式版安装包](https://github.com/2069581059k-eng/DAILY-NOTE/releases/tag/v1.8.22)（BIN/RPK 各 1,295,005 B，SHA-256 `e1d3c429bf88d6e8c2f65f01f34ce0910efabd0b97431771f30149ee981de632`）。

1.8.22 内容：应用图标恢复 1.8.14 经典版（紫蓝魔法书+金色星光），imgs 其余素材映射不变。1.8.21：素材统一 imgs 目录供图——应用图标换新（星光轨道，1.8.22 已撤销）+ 今日日历导航图标补全。1.8.20：右滑退出提示改羊皮纸主题卡片并移至屏幕最上方。1.8.19：收藏室交互对齐知识页（点击正文翻页/正文清洗/去重复副标题/正文框扩容）、星象遮罩移除今日签近签且插图直显当前星座素材、新设计素材 11 枚。1.8.18：全局视觉改版「东方纸韵 · 极简治愈」、星象结果页 12 枚星座插画、P1 左缘触摸死区修复（64px 透明命中层 + 面板下沉）。1.8.14–1.8.17：题库 v2、收藏室独立页（筛选/双布局详情）、签运持久化、右滑交互重构、知识页点击翻页、DAILY NOTE 更名。
