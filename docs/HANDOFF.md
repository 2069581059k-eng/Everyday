...
- Release：https://github.com/2069581059k-eng/Everyday/releases/tag/v1.8.14（**预发布**，2026-09-10 用户指示发布；真机验证后可转正）
...
- 待办：①用户真机安装验证（重点：爱心收藏、收藏室删除后不再复活、新首页布局），验证通过后将 Release 转正并设为新基准；②后续版本 ≥1.8.15/10815，禁止同号覆盖。
